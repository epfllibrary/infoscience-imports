...
def main(start_date="2024-01-01", end_date="2025-01-01", queries=None):
    ...
    zenodo_harvester = ZenodoHarvester(
        start_date, end_date, default_queries["zenodo"]
    )
    zenodo_items = zenodo_harvester.harvest()

    # Merge
    deduplicator = DataFrameProcessor(zenodo_items)
